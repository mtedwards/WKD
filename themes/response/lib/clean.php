...
function reverie_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_style( 'reverie-stylesheet', get_template_directory_uri() . '/css/style.css', array(), '201308151507', 'all' );
    ...
    wp_register_script( 'production-js', get_template_directory_uri() . '/js/build/production.min.js', array( 'jquery' ), '', true );
